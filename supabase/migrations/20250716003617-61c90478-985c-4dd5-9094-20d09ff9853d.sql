-- Melhorar função de processamento de confirmação WhatsApp
-- Incluir notificação para fisioterapeuta em cancelamentos

DROP FUNCTION IF EXISTS public.process_whatsapp_confirmation(text, text, text);
